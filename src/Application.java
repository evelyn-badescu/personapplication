public class Application {
    public static void main(String[] args) {
        ...
        System.out.println(firstperson.name+" marital status is "+firstperson.isMarried());
        ...
        System.out.println(secondperson.name+" marital status is "+secondperson.isMarried());
        ...
        System.out.println(thirdperson.name+" marital status is "+thirdperson.isMarried());
